...
try:
    ...
    cj.plot_1d(u_cos, ax=ax, color=CHEBFUN_BLUE)
...
try:
    ...
    cj.plot_1d(u_sys, ax=ax, color=CHEBFUN_BLUE, label='u')
    cj.plot_1d(v_sys, ax=ax, color=CHEBFUN_RED, label='v')
    ax.legend(fontsize=8)
    ax.grid(True, alpha=0.25, linestyle='--', linewidth=0.4)
    ax.spines['top'].set_visible(False); ax.spines['right'].set_visible(False)
    fig.set_facecolor('white'); fig.tight_layout()
...
try:
    ...
    fig, ax = plt.subplots(figsize=(6, 4))
    tt = jnp.linspace(-1, 1, 600)
    cj.plot_1d(u_nl, ax=ax, color=CHEBFUN_BLUE)
    ax.grid(True, alpha=0.25, linestyle='--', linewidth=0.4)
    ax.spines['top'].set_visible(False); ax.spines['right'].set_visible(False)
    fig.set_facecolor('white'); fig.tight_layout()
    save(fig)
...
try:
    ...
    fig, ax = plt.subplots(figsize=(6, 4))
    tt = jnp.linspace(-PI, PI, 600)
    cj.plot_1d(u_pend, ax=ax, color=CHEBFUN_BLUE)
    ax.grid(True, alpha=0.25, linestyle='--', linewidth=0.4)
    ax.spines['top'].set_visible(False); ax.spines['right'].set_visible(False)
    fig.set_facecolor('white'); fig.tight_layout()
    save(fig)
