...
Python translation: [`examples/approx/divergent_series.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/approx/divergent_series.py)
...
![DivergentSeries figure 01](../../images/approx/DivergentSeries_01.png)
...
```text
      ...
      -0.999999999996  (should be      -1)
       3.999999995632  (should be       4)
     -35.999996697828  (should be     -36)
     575.997944230807  (should be     576)
  -14398.985214163837  (should be  -14400)
  517993.601320972724  (should be  518400)
```
...
1. [http://tiny.cc/wiki_diverge_series/](http://tiny.cc/wiki_diverge_series/)
