...
Python translation: [`examples/approx/nearest_orth_fun.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/approx/nearest_orth_fun.py)
...
Departure from orthogonality in the columns of Q = 2.4e-15
...
![NearestOrthFun figure 01](../../images/approx/NearestOrthFun_01.png)
...
Departure from orthogonality in the columns of Q = 2.4e-15
Departure from orthogonality in the columns of Q2 = 1.4e-15
The distance between A and Q2 = 2.48
The distance between A and its closest orthonormal quasimatrix = 1.62
```

![NearestOrthFun figure 02](../../images/approx/NearestOrthFun_02.png)
...
5. N.J. Higham, The matrix computation toolbox, [http://www.ma.man.ac.uk/~higham/mctoolbox/](http://www.ma.man.ac.uk/~higham/mctoolbox/), 2008.
