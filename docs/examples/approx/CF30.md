...
Python translation: [`examples/approx/cf30.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/approx/cf30.py)
...
```text
Elapsed time is 0.022699 seconds.
```
...
![CF30 figure 01](../../images/approx/CF30_01.png)
...
```text
Elapsed time is 1.333907 seconds.
```
...
![CF30 figure 02](../../images/approx/CF30_02.png)
...
Elapsed time is 0.001085 seconds.
```

![CF30 figure 03](../../images/approx/CF30_03.png)
...
1. L. N. Trefethen, "Matlab programs for CF approximation," in C. K. Chui, L. L. Schumaker, and J. D. Ward, eds., *Approximation Theory V*, Academic Press, 1986, pp. 599-602.
