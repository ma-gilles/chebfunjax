...
<!-- Source: https://www.chebfun.org/examples/approx/WeierstrassFunction.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>A pathological function of Weierstrass</h1>
<h2>Hrothgar, October 2013 in <a href='../'>approx</a><span><a href='/examples/approx/WeierstrassFunction.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/approx/WeierstrassFunction.m'>view on GitHub</a></span></h2>
</div>

<div id='content' class="col-sm-12 example" role="main">
<pre class="mcode-input">format compact</pre>

<p>In the late nineteenth century, Karl Weierstrass rocked the analysis community when he constructed an example of a function that is everywhere continuous but nowhere differentiable. His now eponymous function, also one of the first appearances of fractal geometry, is defined as the sum $$ \sum_{k=0}^{\infty} a^k \cos(b^k \pi x), $$ where $0 &lt; a &lt; 1$ and $b$ is a positive odd integer with $ab &lt; 1 + \frac32 \pi$. Since its publication, Weierstrass's work has been generalized in many directions.</p>
...
----------------------------------------------------
 2   -1.0000000      +0.0000000        0.02 sec
 4   -0.6196232      -0.0504416        0.02 sec
 6   -0.6010220      -0.1761766        0.03 sec
 8    0.6000610      -0.2098447        0.41 sec
...
<li>
<p>L. N. Trefethen, <em>Approximation Theory and Approximation Practice, Extended Edition</em>, SIAM, 2019._</p>
</li>
</ol></div>
        </div>
    </div>
