...
Python translation: [`examples/ode-nonlin/guckenheimer_holmes.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/ode-nonlin/guckenheimer_holmes.py)
...
![GuckenheimerHolmes figure 01](../../images/ode-nonlin/GuckenheimerHolmes_01.png)
...
![GuckenheimerHolmes figure 02](../../images/ode-nonlin/GuckenheimerHolmes_02.png)
...
![GuckenheimerHolmes figure 03](../../images/ode-nonlin/GuckenheimerHolmes_03.png)
...
![GuckenheimerHolmes figure 04](../../images/ode-nonlin/GuckenheimerHolmes_04.png)

## References

1. F. H. Busse and K. E. Heikes, Convection in a rotating layer: a simple case of turbulence, *Science* 208 (1980), 173-175.
2. J. Guckenheimer and P. Holmes, Structurally stable heteroclinic cycles, *Math. Proc. Camb. Phil. Soc.* 103 (1988), 189-192.
3. P. Holmes, J. L. Lumley, G. Berkooz, and C. W. Rowley, *Turbulence, Coherent Structures, Dynamical Systems and Symmetry*, 2nd ed., Cambridge, 2012.
