...
Python translation: [`examples/ode-nonlin/blowup_fk.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/ode-nonlin/blowup_fk.py)
...
![BlowupFK figure 01](../../images/ode-nonlin/BlowupFK_01.png)

## References

1. H. Fujita, On the nonlinear equations $\Delta u + \exp(u) = 0$ and $dv/dt = \Delta v + \exp(v)$, *Bulletin of the American Mathematical Society*, 75 (1969), 132-135.
