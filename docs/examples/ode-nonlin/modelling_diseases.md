...
<!-- Source: https://www.chebfun.org/examples/ode-nonlin/ModellingDiseases.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>Modelling infectious disease outbreaks</h1>
<h2>Hrothgar, October 2014 in <a href='../'>ode-nonlin</a><span><a href='/examples/ode-nonlin/ModellingDiseases.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/ode-nonlin/ModellingDiseases.m'>view on GitHub</a></span></h2>
</div>
...
<p>We will use chebop's nonlinear backslash syntax to solve the problem.</p>
<pre class="mcode-input">[S,I,R] = N\0;</pre>
