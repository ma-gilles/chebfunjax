...
Python translation: [`examples/cheb/exact_cheb_coeffs.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/cheb/exact_cheb_coeffs.py)
...
![ExactChebCoeffs figure 01](../../images/cheb/ExactChebCoeffs_01.png)
