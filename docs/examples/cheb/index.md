# Chebyshev Expansion Examples

These examples illuminate the mathematical foundations of chebfunjax —
the Chebyshev polynomials themselves, the FFT connection, and the
theory of polynomial approximation in the Chebyshev basis.
...
| [Fast Chebyshev-Legendre transform (replica)](FastChebyshevLegendreTransform.md) | Faithful replica: Chebyshev vs Legendre coefficient families for geometric and algebraic decay. |
| [Fast discrete Legendre transform (replica)](FastDLT.md) | Faithful replica: DLT at N=1e4 in under a second; roundtrip 2.2e-15. |
...
| [Convergence Rates for Functions of Fractional Smoothness](convergence.md) | Original MATLAB: cheb/Convergence Author: Alex Townsend (October 2010, revised July 2019) |
| [The Doublelength Flag](doublelength_flag.md) | Original MATLAB: cheb/DoublelengthFlag Author: Nick Trefethen (February 2015) |
| [Exact Chebyshev Expansion Coefficients](exact_cheb_coeffs.md) | Original MATLAB: cheb/ExactChebCoeffs Author: Mark Richardson (June 2012) |
| [What's the Noise Level of a Chebyshev Series?](noise_level.md) | Original MATLAB: cheb/NoiseLevel Author: Nick Trefethen (6 July 2016) |
| [High-Accuracy Chebyshev Coefficients and 'Turbo'](turbo.md) | Original MATLAB: cheb/Turbo Author: Anthony Austin and Nick Trefethen (July 2015) |
