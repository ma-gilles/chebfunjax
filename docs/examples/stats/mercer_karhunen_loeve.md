...
<!-- Source: https://www.chebfun.org/examples/stats/MercerKarhunenLoeve.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>Mercer's theorem and the Karhunen-Loeve expansion</h1>
<h2>Toby Driscoll, December 2011 in <a href='../'>stats</a><span><a href='/examples/stats/MercerKarhunenLoeve.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/stats/MercerKarhunenLoeve.m'>view on GitHub</a></span></h2>
</div>
...
<pre class="mcode-input">F = chebop(@(u) fred(K, u));
