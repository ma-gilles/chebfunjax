...
Python translation: [`examples/stats/bayesian_gradebook.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/stats/bayesian_gradebook.py)
...
![BayesianGradebook figure 01](../../images/stats/BayesianGradebook_01.png)
...
![BayesianGradebook figure 02](../../images/stats/BayesianGradebook_02.png)
...
```text
scores =
  0.850000000000000  0.970000000000000  0.920000000000000  0.960000000000000
Method          m-3    m-2    m-1      m
------------------------------------------------
...
![BayesianGradebook figure 03](../../images/stats/BayesianGradebook_03.png)
...
![BayesianGradebook figure 04](../../images/stats/BayesianGradebook_04.png)
...
```text
scores =
  0.720000000000000  0.970000000000000  0.920000000000000  0.960000000000000
```
