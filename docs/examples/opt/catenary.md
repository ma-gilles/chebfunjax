...
<!-- Source: https://www.chebfun.org/examples/opt/Catenary.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>The catenary problem from the calculus of variations</h1>
<h2>Hrothgar and Toby Driscoll, April 2014 in <a href='../'>opt</a><span><a href='/examples/opt/Catenary.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/opt/Catenary.m'>view on GitHub</a></span></h2>
</div>
