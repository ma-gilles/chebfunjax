...
<!-- Source: https://www.chebfun.org/examples/opt/ConstrainedExtrema.html -->
...
<h2>Olivier Sète, November 2016 in <a href='../'>opt</a><span><a href='/examples/opt/ConstrainedExtrema.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/opt/ConstrainedExtrema.m'>view on GitHub</a></span></h2>
</div>
