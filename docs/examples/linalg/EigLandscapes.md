...
![EigLandscapes figure 01](../../images/linalg/EigLandscapes_01.png)
...
![EigLandscapes figure 02](../../images/linalg/EigLandscapes_02.png)
...
![EigLandscapes figure 03](../../images/linalg/EigLandscapes_03.png)
...
![EigLandscapes figure 04](../../images/linalg/EigLandscapes_04.png)
...
![EigLandscapes figure 05](../../images/linalg/EigLandscapes_05.png)

Eigenvalue crossings are fascinating and can be found in a number of Chebfun examples. In particular, this example is a 2D analogue of "Eigenvalue level repulsion" ([http://www.chebfun.org/examples/linalg/LevelRepulsion.html](LevelRepulsion.md)). The nontrivial zeros of the Riemann zeta function are conjectured to be related to the eigenvalues of a hermitian (not real symmetric) operator.
