...
Python translation: [`examples/linalg/cond_vandermonde.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/linalg/cond_vandermonde.py)
...
![CondVandermonde figure 01](../../images/linalg/CondVandermonde_01.png)
