...
<!-- Source: https://www.chebfun.org/examples/fun/ValentinesDay2.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>Happy Valentines Day! (again)</h1>
<h2>Anonymous, February 2013 in <a href='../'>fun</a><span><a href='/examples/fun/ValentinesDay2.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/fun/ValentinesDay2.m'>view on GitHub</a></span></h2>
</div>

<div id='content' class="col-sm-12 example" role="main">
<p>Happy Valentines day to all Chebfun2 users! Copy and paste this M-file into your Matlab to watch the love movie.</p>
<pre class="mcode-input">d = [0 1 0 4*pi];
t = chebfun2(@(t,th) t, d);
th = chebfun2(@(t,th) th, d);</pre>

<p>Parametric surface:</p>
<pre class="mcode-input">X = sin(pi*t).*cos(th/2);
Y = 0.7*sin(pi*t).*sin(th/2);
Z = (t-1).*(-49+50*t+30*t.*cos(th)+cos(2*th))./(-25+(cos(th)).^2);</pre>

<p>Color scheme:</p>
<pre class="mcode-input">C = sin(10*X).*cos((Y-.1).^2)+(Z+1);

% Message:
S = scribble('Happy Valentines Day!');</pre>

<p>Generate surface:</p>
...
<p>Reference</p>
<ol>
<li>Anonymous, 14th February 2013, Chebfun Example    <a href="../fun/ValentinesDay.html">fun/ValentinesDay</a></li>
</ol></div>
        </div>
</div>
