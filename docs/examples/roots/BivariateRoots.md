...
Python translation: [`examples/roots/bivariate_roots.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/roots/bivariate_roots.py)
...
(The curves we selected were obtained by modifying curves from Example [complex/RoucheTheorem](../complex/RoucheTheorem.md)).
...
![BivariateRoots figure 01](../../images/roots/BivariateRoots_01.png)
...
![BivariateRoots figure 02](../../images/roots/BivariateRoots_02.png)
