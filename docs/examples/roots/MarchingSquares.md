...
Python translation: [`examples/roots/marching_squares.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/roots/marching_squares.py)
...
![MarchingSquares figure 01](../../images/roots/MarchingSquares_01.png)
...
![MarchingSquares figure 02](../../images/roots/MarchingSquares_02.png)
...
![MarchingSquares figure 03](../../images/roots/MarchingSquares_03.png)
...
![MarchingSquares figure 04](../../images/roots/MarchingSquares_04.png)
...
1. Chebfun Example [fun/ContourFun](https://www.chebfun.org/examples/fun/ContourFun.html)
...
4. Marching Squares, Wikipedia article, [http://en.wikipedia.org/wiki/Marching_squares](http://en.wikipedia.org/wiki/Marching_squares)
5. Marching Triangles, Wikipedia article, [http://en.wikipedia.org/wiki/Marching_triangles](http://en.wikipedia.org/wiki/Marching_triangles)
