...
Python translation: [`examples/disk/eigenfunctions.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/disk/eigenfunctions.py)
...
In Diskfun, we can construct these functions using `diskfun.harmonic`. The parameters passed to the function are $m$ and $n$, respectively, in (3) and (4). If $m$ is chosen as a nonnegative integer, then the function constructed is $u_{mn} = A_{mn} J_m(\lambda_{mn} r) \cos(m\theta)$, where $A_{mn}$ is the normalization factor. For $m<0$, the function $v_{|m|n} = B_{|m|n} J_{|m|}(\lambda_{|m|n} r) \sin(|m|\theta)$ is constructed. For example, here is $u_{4, 2}$:
...
We can verify that $u_{4,2}$ is an eigenfunction of Laplace's equation. The associated eigenvalue is related to the second positive zero of the function $J_{4}(r)$. We find this using `roots` in Chebfun, and then use `lap` to compute the Laplacian on the disk.
...
![Eigenfunctions figure 02](../../images/disk/Eigenfunctions_02.png)

![Eigenfunctions figure 03](../../images/disk/Eigenfunctions_03.png)
...
![Eigenfunctions figure 04](../../images/disk/Eigenfunctions_04.png)

![Eigenfunctions figure 05](../../images/disk/Eigenfunctions_05.png)
...
![Eigenfunctions figure 06](../../images/disk/Eigenfunctions_06.png)
...
![Eigenfunctions figure 07](../../images/disk/Eigenfunctions_07.png)
...
![Eigenfunctions figure 08](../../images/disk/Eigenfunctions_08.png)
...
![Eigenfunctions figure 09](../../images/disk/Eigenfunctions_09.png)
...
![Eigenfunctions figure 10](../../images/disk/Eigenfunctions_10.png)

![Eigenfunctions figure 11](../../images/disk/Eigenfunctions_11.png)
