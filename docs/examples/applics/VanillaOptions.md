...
![VanillaOptions figure 01](../../images/applics/VanillaOptions_01.png)

The payoffs at expiry (the blue lines in both figures) show an evident but important difference in the gains of going long on a call or a put: for the former it is bounded by $K$ while for the later it is unbounded. The eight black lines, from lowest to highest, show the prices for expiry times $2^{-1},2^0,2^1,\ldots,2^8$, and the red line shows the profile for $T=1,000$, which is effectively infinity (in practice it is rare to find options with maturities longer than 10 years).
...
We consider three strategies based on the choice of the put: one with the same parameters as the call (blue), one with a higher strike and shorter maturity (red), and one with lower strike, longer maturity and slightly larger notional of 1.03 instead of 1 (black). We set these strikes/maturities so the hedge is at par when $S=100$.
...
![VanillaOptions figure 03](../../images/applics/VanillaOptions_03.png)
...
![VanillaOptions figure 04](../../images/applics/VanillaOptions_04.png)
...
![VanillaOptions figure 05](../../images/applics/VanillaOptions_05.png)
...
![VanillaOptions figure 06](../../images/applics/VanillaOptions_06.png)
...
We finish this example by repeating the calculations of the imperfect hedge for the call, using the put-call parity relation for the case of non-zero interest rates, given by
...
![VanillaOptions figure 07](../../images/applics/VanillaOptions_07.png)
...
1. S. Natenberg, *Option Volatility & Pricing: Advanced Trading Strategies and Techniques*, McGraw-Hill Professional, 2nd edition, 1994.
2. J. Hull, *Options, Futures and Other Derivatives*, Pearson Education, 9th edition, 2014.
