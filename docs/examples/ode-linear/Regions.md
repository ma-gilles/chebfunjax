...
Python translation: [`examples/ode-linear/regions.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/ode-linear/regions.py)
...
![Regions figure 01](../../images/ode-linear/Regions_01.png)
...
![Regions figure 02](../../images/ode-linear/Regions_02.png)
...
![Regions figure 03](../../images/ode-linear/Regions_03.png)
...
![Regions figure 04](../../images/ode-linear/Regions_04.png)

## References

1. E. Hairer and G. Wanner, *Solving Ordinary Differential Equations II: Stiff and Differential-Algebraic Problems*, Springer, 1996.
