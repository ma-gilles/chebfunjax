...
Python translation: [`examples/ode-linear/contour_expm.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/ode-linear/contour_expm.py)
...
![ContourExpm figure 01](../../images/ode-linear/ContourExpm_01.png)
...
![ContourExpm figure 02](../../images/ode-linear/ContourExpm_02.png)
...
![ContourExpm figure 03](../../images/ode-linear/ContourExpm_03.png)
...
1. Trefethen, L. N. "Heat Equation via EXPM". [http://www2.maths.ox.ac.uk/chebfun/examples/pde/html/Erosion.shtml](http://www2.maths.ox.ac.uk/chebfun/examples/pde/html/Erosion.shtml)
2. Trefethen, L. N. "Ten Digit Algorithms". [http://people.maths.ox.ac.uk/trefethen/tda.html](http://people.maths.ox.ac.uk/trefethen/tda.html)
...
4. Weideman, J. A. C. Optimizing Talbot's contours for the inversion of the Laplace transform. SIAM J. Numer. Anal., Vol. 44, No. 6, 2006, pp. 2342-2362.
