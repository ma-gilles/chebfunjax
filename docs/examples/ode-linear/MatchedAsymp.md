...
Python translation: [`examples/ode-linear/matched_asymp.py`](https://github.com/ma-gilles/chebfunjax/blob/main/examples/ode-linear/matched_asymp.py)
...
```text
Elapsed time is 27.068558 seconds.
```

![MatchedAsymp figure 01](../../images/ode-linear/MatchedAsymp_01.png)
...
![MatchedAsymp figure 02](../../images/ode-linear/MatchedAsymp_02.png)
...
![MatchedAsymp figure 03](../../images/ode-linear/MatchedAsymp_03.png)
