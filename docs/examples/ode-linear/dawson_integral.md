...
<!-- Source: https://www.chebfun.org/examples/ode-linear/DawsonIntegral.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>Dawson's integral</h1>
<h2>Kuan Xu, October 2012 in <a href='../'>ode-linear</a><span><a href='/examples/ode-linear/DawsonIntegral.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/ode-linear/DawsonIntegral.m'>view on GitHub</a></span></h2>
</div>
...
f = L\1;
toc
plot(f), axis([-W W -H H]), hold on, grid on</pre>
...
<pre class="mcode-output">Elapsed time is 0.057716 seconds.
</pre>
