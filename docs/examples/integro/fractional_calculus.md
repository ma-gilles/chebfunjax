...
<!-- Source: https://www.chebfun.org/examples/integro/FracCalc.html -->

<div class="chebfun-import chebfun-example-import">
<div class='page-header'>
<h1>Fractional calculus in Chebfun</h1>
<h2>Nick Hale, October 2010 in <a href='../'>integro</a><span><a href='/examples/integro/FracCalc.m'>download</a><span class='sep-sm'>&middot;</span><a href='//github.com/chebfun/examples/blob/master/integro/FracCalc.m'>view on GitHub</a></span></h2>
</div>

<div id='content' class="col-sm-12 example" role="main">
<p>We're all familiar with the standard definitions of differentiation and integration we learnt in high-school and at undergraduate level. For example, here is the function $x$ on the interval [0,4] along with its derivative (the constant function, $1$) and antiderivative ($x^2/2$).</p>
...
<p><img src="../../../images/integro/FracCalc_01.png" class="figure chebfun-figure" alt=""/></p>
...
<p><img src="../../../images/integro/FracCalc_02.png" class="figure chebfun-figure" alt=""/></p>
...
<p>Below we demonstrate the $a$ th derivative of $x$ for $a = 0.1, 0.2,\dots, 1$.</p>
...
<p><img src="../../../images/integro/FracCalc_03.png" class="figure chebfun-figure" alt=""/></p>
...
<p><img src="../../../images/integro/FracCalc_04.png" class="figure chebfun-figure" alt=""/></p>
...
<p><img src="../../../images/integro/FracCalc_05.png" class="figure chebfun-figure" alt=""/></p>
...
<p><img src="../../../images/integro/FracCalc_06.png" class="figure chebfun-figure" alt=""/></p>
...
<p><img src="../../../images/integro/FracCalc_07.png" class="figure chebfun-figure" alt=""/></p>
