"""Port of MATLAB Chebfun tests/adchebfun/test_cumsumDiffSumMean.m (Fable 5).

Provenance
----------
MATLAB source : tests/adchebfun/test_cumsumDiffSumMean.m
...
class TestAdchebfunCumsumdiffsummean:
