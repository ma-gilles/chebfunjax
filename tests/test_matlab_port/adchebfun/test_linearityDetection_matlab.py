"""Port of MATLAB Chebfun tests/adchebfun/test_linearityDetection.m (Fable 5).

Provenance
----------
MATLAB source : tests/adchebfun/test_linearityDetection.m
...
class TestAdchebfunLinearitydetection:
