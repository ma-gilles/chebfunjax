"""Port of MATLAB Chebfun tests/adchebfun/test_lintest_rdivide.m (Fable 5).

Provenance
----------
MATLAB source : tests/adchebfun/test_lintest_rdivide.m
...
class TestAdchebfunLintestRdivide:
