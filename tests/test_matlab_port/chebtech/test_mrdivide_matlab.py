...
Every assertion in the MATLAB file exercises the tech-level 'mrdivide'
method on (mostly array-valued) chebtechs.  chebfunjax techs are
single-column and have no 'mrdivide' method; quasimatrix least-squares/QR
...
pytestmark = pytest.mark.skip(
    reason="chebfunjax techs have no mrdivide method (single-column techs; "
