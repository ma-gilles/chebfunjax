...
chebfunjax Singfun implements no ``real`` method and does not support complex
smooth parts, so the non-trivial assertions are xfailed (the ``real`` call
...
_REASON = "chebfunjax Singfun has no real() method / no complex support"
