...
from chebfunjax.chebfun1d.chebfun import bvp5c, chebfun
...
class TestChebfunBvp5c:
    def test_all_matlab_assertions(self):
        ...
        sol, p = bvp5c(mat4ode, mat4bc, solinit, lam, opts)
