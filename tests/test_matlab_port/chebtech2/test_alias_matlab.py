...
All assertions run live against ``chebtech.alias`` (coefficient aliasing
/ folding onto a shorter Chebyshev grid) and ``chebtech.bary``, at the
MATLAB tolerances.  (This file was originally all-xfail; the Fable 5
fleet added alias/array-valued techs, and bary closed the last case.)
