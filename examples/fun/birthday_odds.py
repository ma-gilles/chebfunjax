...
Translation of fun/BirthdayOdds.m by Jared Aurentz
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "BirthdayOdds_01.png"))
    ...
    ax.plot(ns, np.asarray(p(ns)), 'r', lw=1.2)              # hold on
    _savefig(fig, os.path.join(_IMG, "BirthdayOdds_02.png"))
    plt.close(fig)
