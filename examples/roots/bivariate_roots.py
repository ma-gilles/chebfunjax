...
Translation of roots/BivariateRoots.m by Yuji Nakatsukasa,
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "BivariateRoots_01.png"))
    ...
    _savefig(fig, os.path.join(_IMG, "BivariateRoots_02.png"))
    plt.close(fig)
