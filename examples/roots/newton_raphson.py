...
Translation of roots/NewtonRaphson.m by Kuan Xu (October 2012):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "NewtonRaphson_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "NewtonRaphson_02.png"), size=(600, 270))
    plt.close(fig)
    print("root1 =")
    print(f"  {xnew:.15f}")
