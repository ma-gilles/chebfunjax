...
Translation of roots/AAAZeros.m by Nick Trefethen
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAAZeros_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAAZeros_02.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAAZeros_03.png"))
    plt.close(fig)
