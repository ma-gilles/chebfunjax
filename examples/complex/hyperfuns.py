...
Translation of complex/Hyperfuns.m by Nick Trefethen (June 2013):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Hyperfuns_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Hyperfuns_02.png"))
    plt.close(fig)
