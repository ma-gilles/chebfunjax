...
Translation of complex/ClosedContours.m by Mohsin Javed (October
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "ClosedContours_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "ClosedContours_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "ClosedContours_03.png"), size=(600, 270))
    plt.close(fig)
    print("s =")
