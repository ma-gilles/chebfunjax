...
Translation of stats/LeastSquares.m by Alex Townsend
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "LeastSquares_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "LeastSquares_02.png"), size=(600, 270))
    plt.close(fig)
