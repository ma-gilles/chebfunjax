...
Translation of ode-eig/OpticalResponse.m by Jared L. Aurentz and
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OpticalResponse_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OpticalResponse_02.png"), size=(600, 270))
    plt.close(fig)
