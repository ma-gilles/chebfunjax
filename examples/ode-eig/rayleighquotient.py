...
Translation of ode-eig/RayleighQuotient.m by Nick Hale and Yuji
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "RayleighQuotient_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "RayleighQuotient_02.png"), size=(600, 270))
    plt.close(fig)
