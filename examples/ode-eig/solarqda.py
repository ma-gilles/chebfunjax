...
Translation of ode-eig/SolarQDA.m by Toby Driscoll (May 2011):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolarQDA_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolarQDA_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolarQDA_03.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolarQDA_04.png"), size=(600, 270))
    plt.close(fig)
