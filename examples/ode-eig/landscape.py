...
Translation of ode-eig/Landscape.m by Nick Trefethen (August
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Landscape_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Landscape_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Landscape_03.png"), size=(600, 270))
    plt.close(fig)
