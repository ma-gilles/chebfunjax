...
Translation of calc/Integrals.m by Nick Trefethen: integrals of a
...
def run():
    ...
    _plot([f], ["b"], "Integrals_01", ylim=(-2.5, 2.5))
    ...
    _plot([f, h], ["b", "r"], "Integrals_03", ylim=(-2.5, 2.5))
