...
Translation of calc/ForTheBirds.m by Toby Driscoll: a bird flying
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "ForTheBirds_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    for WL in (1.05, 5.0, 50.0):
        ...
        if WL == 1.05:
            ...
            fig.set_facecolor("white")
            fig.tight_layout()
            _savefig(fig, os.path.join(_IMG, "ForTheBirds_02.png"), size=(600, 270))
            plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "ForTheBirds_03.png"), size=(600, 270))
    plt.close(fig)
