...
Translation of calc/SnellsLaw.m by Mohsin Javed: a lifeguard's
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SnellsLaw_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SnellsLaw_02.png"), size=(600, 270))
    plt.close(fig)
