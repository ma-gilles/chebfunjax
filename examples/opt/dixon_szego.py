...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "DixonSzego_01.png"))
    ax.plot(minx, float(miny), '.k', ms=14)                 # hold on
    _savefig(fig, os.path.join(_IMG, "DixonSzego_02.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "DixonSzego_03.png"))
    plt.close(fig)
