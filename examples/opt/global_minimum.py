...
Translation of opt/GlobalMinimum.m by Alex Townsend
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "GlobalMinimum_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "GlobalMinimum_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "GlobalMinimum_03.png"), size=(600, 270))
    plt.close(fig)
