...
Translation of opt/MercuryEarth.m by Tonatiuh Sanchez-Vizuet
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "MercuryEarth_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "MercuryEarth_02.png"))
    plt.close(fig)
