...
Translation of linalg/LevelRepulsion.m by Nick Trefethen
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "LevelRepulsion_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "LevelRepulsion_02.png"))
    plt.close(fig)
