...
def run():
    ...
    axes[0].set_xlabel("S"); axes[0].legend(fontsize=9); axes[0].grid(True, alpha=0.3)
    ...
    axes[1].set_xlabel("S"); axes[1].legend(fontsize=9); axes[1].grid(True, alpha=0.3)
    ...
    axes[2].set_xlabel("S"); axes[2].legend(fontsize=9); axes[2].grid(True, alpha=0.3)
