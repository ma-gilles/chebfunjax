...
def run():
    ...
    axes[1, 1].plot(S_atm, C_atm, color='#0072BD', linestyle='-', linewidth=2, label='Call')
    axes[1, 1].plot(S_atm, P_atm, color='#D95319', linestyle='-', linewidth=2, label='Put')
    axes[1, 1].plot(S_atm, payoff(S_atm, K, 1), color='#0072BD', linestyle='--', linewidth=1, alpha=0.5)
    axes[1, 1].plot(S_atm, payoff(S_atm, K, -1), color='#D95319', linestyle='--', linewidth=1, alpha=0.5)
