...
Translation of cheb/FastDLT.m by Nick Hale and Alex Townsend
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "FastDLT_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "FastDLT_02.png"))
    plt.close(fig)
