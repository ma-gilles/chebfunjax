...
from chebfunjax.utils.transforms import cheb2leg, leg2cheb, vals2coeffs
...
def run():
    ...
    axes[0].semilogy(c_ch + 1e-17, color='#0072BD', marker='.', linestyle='-', label='Chebyshev')
    axes[0].semilogy(c_lg + 1e-17, color='#D95319', marker='.', linestyle='-', label='Legendre')
