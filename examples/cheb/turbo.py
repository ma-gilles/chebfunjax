...
Translation of cheb/Turbo.m by Nick Trefethen (January 2019):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Turbo_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Turbo_02.png"), size=(600, 270))
    plt.close(fig)
