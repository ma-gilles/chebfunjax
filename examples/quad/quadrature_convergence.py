...
Translation of quad/QuadratureConvergence.m by Nick Trefethen:
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "QuadratureConvergence_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "QuadratureConvergence_02.png"), size=(600, 270))
    plt.close(fig)
