...
Translation of approx/AbsoluteValueScaled.m by Yuji Nakatsukasa
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AbsoluteValueScaled_01.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AbsoluteValueScaled_02.png"))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AbsoluteValueScaled_03.png"))
    plt.close(fig)
