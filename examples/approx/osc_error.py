...
Translation of approx/OscError.m by Mohsin Javed (October 2013):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OscError_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OscError_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OscError_03.png"), size=(600, 270))
    plt.close(fig)
