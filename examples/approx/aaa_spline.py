...
Translation of approx/AAASpline.m by Nick Trefethen (February
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAASpline_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAASpline_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "AAASpline_03.png"), size=(600, 270))
    plt.close(fig)
