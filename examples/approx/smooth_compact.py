...
Translation of approx/SmoothCompact.m by Nick Trefethen (May
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SmoothCompact_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SmoothCompact_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SmoothCompact_03.png"), size=(600, 270))
    plt.close(fig)
