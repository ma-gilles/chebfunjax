...
Translation of approx/Splines.m by Nick Trefethen (February
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Splines_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Splines_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Splines_03.png"), size=(600, 270))
    plt.close(fig)
