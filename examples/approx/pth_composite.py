...
Translation of approx/PthComposite.m by Evan Gawlik and Yuji
...
def run():
    ...
    _semilog(xx, abserr,
             ...
             "PthComposite_03.png", vline=0.03**P, vmax=vmax)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "PthComposite_06.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "PthComposite_07.png"), size=(600, 270))
    plt.close(fig)
