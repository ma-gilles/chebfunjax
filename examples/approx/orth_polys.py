...
Translation of approx/OrthPolys.m by Stefan Guettel (June 2011):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OrthPolys_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "OrthPolys_02.png"), size=(600, 270))
    plt.close(fig)
