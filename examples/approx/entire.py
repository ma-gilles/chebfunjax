...
Translation of approx/Entire.m by Mark Richardson (September
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Entire_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Entire_02.png"), size=(600, 270))
    plt.close(fig)
