...
Translation of approx/Local.m by Nick Trefethen (February 2013):
...
def run():
    ...
    scan(f, (-1.0, 1.0), 1e-6, 0.04, "Local_01.png")
    ...
    u = N.solve(1.0)
    scan(u, (-10.0, 10.0), 1e-6, 0.2, "Local_02.png")

    # Zoom into [8, 10]
    scan(u, (8.0, 10.0), 1e-6, 0.2, "Local_03.png")
