...
Translation of approx/EightShades.m by Nick Trefethen (May 2016):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "EightShades_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "EightShades_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "EightShades_03.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "EightShades_04.png"), size=(600, 270))
    plt.close(fig)
