...
Translation of approx/AliasingCoefficients.m by Yuji Nakatsukasa
...
def run():
    ...
    _coeff_plot(f, p, "AliasingCoefficients_01.png")
    ...
    _coeff_plot(f2, p2, "AliasingCoefficients_02.png",
                xmax=len(f2) / 2)
