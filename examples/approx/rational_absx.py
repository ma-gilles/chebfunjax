...
Translation of approx/RationalAbsx.m by Nick Trefethen (March 2017): the
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "RationalAbsx_01.png"), size=(600, 268))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "RationalAbsx_02.png"), size=(600, 268))
    plt.close(fig)
