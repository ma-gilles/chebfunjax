...
Translation of approx/WeierstrassFunction.m by Hrothgar (October
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "WeierstrassFunction_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "WeierstrassFunction_02.png"), size=(600, 270))
    plt.close(fig)
