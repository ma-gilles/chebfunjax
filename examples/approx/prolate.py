...
Translation of approx/Prolate.m by Nick Trefethen (May 2021):
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Prolate_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Prolate_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Prolate_03.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Prolate_04.png"), size=(600, 270))
    plt.close(fig)
