...
Translation of approx/Halphen.m by Nick Trefethen (May 2011): the
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Halphen_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Halphen_02.png"), size=(600, 270))
    plt.close(fig)
