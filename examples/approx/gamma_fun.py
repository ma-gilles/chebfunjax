...
Translation of approx/GammaFun.m by Nick Trefethen (September
...
def run():
    ...
    print("gam =")
    print(repr(gam))
    _plot_gam([gam], [r"$\Gamma(x)$"], "GammaFun_01.png",
              "Gamma function")
    ...
    print("gam =")
    print(repr(gam))
    _plot_gam([gam], [r"$\Gamma(x)$"], "GammaFun_02.png",
    ...
    _plot_gam([gam, gam_i, sqrtgam],
              [r"$\Gamma(x)$", r"$1/\Gamma(x)$",
               r"$\sqrt{|\Gamma(x)|}$"],
              "GammaFun_03.png", "Various related functions")
    ...
    _plot_gam([gam, gam_i, sqrtgam],
              [r"$\Gamma(x)$", r"$1/\Gamma(x)$",
               r"$\sqrt{|\Gamma(x)|}$"],
              "GammaFun_04.png", "Critical points", dots=dots)
