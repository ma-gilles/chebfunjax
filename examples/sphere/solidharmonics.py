...
Translation of sphere/SolidHarmonics.m: the solid harmonics
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolidHarmonics_01.png"), size=(600, 253))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "SolidHarmonics_02.png"), size=(600, 253))
    plt.close(fig)
