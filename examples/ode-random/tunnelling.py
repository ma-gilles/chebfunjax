...
Translation of ode-random/Tunnelling.m by Nick Trefethen (May
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Tunnelling_01.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Tunnelling_02.png"), size=(600, 270))
    plt.close(fig)
    ...
    fig.set_facecolor("white")
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "Tunnelling_03.png"), size=(600, 270))
    plt.close(fig)
