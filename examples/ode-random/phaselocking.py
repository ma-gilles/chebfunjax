...
Translation of ode-random/PhaseLocking.m by Kevin Burrage and
...
def run():
    ...
    _panel(0.2, 6, 100, "PhaseLocking_01.png")
    _panel(0.05, 6, 200, "PhaseLocking_02.png")
    _panel(0.05, 60, 300, "PhaseLocking_03.png")
