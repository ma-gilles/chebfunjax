...
Translation of ode-random/RandomSwitching.m by Nick Trefethen
...
def run():
    ...
    fig.tight_layout()
    _savefig(fig, os.path.join(_IMG, "RandomSwitching_01.png"), size=(600, 269))
    plt.close(fig)
    ...
    panels = [(3.0, 53, (-3, 3), (1e-5, 1e2),
               "RandomSwitching_02.png"),
              (1.0, 54, (-300, 300), (1e-1, 1e6),
               "RandomSwitching_03.png"),
              (1.0 / 3.0, 50, (-3, 3), (1e-8, 1e2),
               "RandomSwitching_04.png")]
