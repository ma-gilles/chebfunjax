...
_F = {
    ...
    "!": [[.4 + 1j, .4 + .2j],
          [.35, .45, .45 + .05j, .35 + .05j, .35]],
    "'": [[.3 + .7j, .4 + 1j]],
    ";": [[0.275 + 0.15j, 0.325 + 0.15j, 0.475 + 0.35j, 0.425 + 0.35j,
           0.275 + 0.15j],
          [0.425 + 0.7j, 0.475 + 0.7j, 0.475 + 0.75j, 0.425 + 0.75j,
           0.425 + 0.7j]],
    ":": [[0.375 + 0.3j, 0.425 + 0.3j, 0.425 + 0.35j, 0.375 + 0.35j,
           0.375 + 0.3j],
          [0.375 + 0.7j, 0.425 + 0.7j, 0.425 + 0.75j, 0.375 + 0.75j,
           0.375 + 0.7j]],
    '"': [[.33 + .8j, .33 + 1j], [.66 + .8j, .66 + 1j]],
    "`": [[.5 + .7j, .4 + 1j]],
    "_": [[-.1, .9]],
    ")": [[.3 + 1j, .4 + .9j, .5 + .75j, .5 + .25j, .4 + .1j, .3]],
    "(": [[.5 + 1j, .4 + .9j, .3 + .75j, .3 + .25j, .4 + .1j, .5]],
    "[": [[.5, .3, .3 + 1j, .5 + 1j]],
    "]": [[.3, .5, .5 + 1j, .3 + 1j]],
    "{": [[.5, .4 + .1j, .4 + .4j, .3 + .5j, .4 + .6j, .4 + .9j, .5 + 1j]],
    "}": [[.3, .4 + .1j, .4 + .4j, .5 + .5j, .4 + .6j, .4 + .9j, .3 + 1j]],
    "-": [[.1 + .5j, .7 + .5j]],
    "+": [[.5j, .8 + .5j, .4 + .5j, .4 + .9j, .4 + .1j]],
    "*": [[.4 + .7j, .4 + .9j], [.32 + .73j, .48 + .87j],
          [.48 + .73j, .32 + .87j]],
    "/": [[.2, .6 + 1j]],
    "^": [[.2 + .7j, .4 + 1j, .6 + .7j]],
    "=": [[.1 + .4j, .7 + .4j], [.1 + .6j, .7 + .6j]],
    ...
    "|": [[.4, .4 + 1j]],
    "%": [[.1, .7 + 1j],
          [0.2 + 0.85j, 0.35 + 0.85j, 0.35 + 1j, 0.2 + 1j, 0.2 + 0.85j],
          [0.5 + 0.05j, 0.65 + 0.05j, 0.65 + 0.2j, 0.5 + 0.2j, 0.5 + 0.05j]],
    "#": [[.3 + .1j, .3 + .9j], [.5 + .1j, .5 + .9j],
          [.2 + .3j, .6 + .3j], [.2 + .7j, .6 + .7j]],
    "~": [[.2 + .45j, .3 + .55j, .5 + .45j, .6 + .55j]],
    "@": [[.8, 0, 1j, .8 + 1j, .8 + .25j, .2 + .25j, .2 + .75j, .6 + .75j,
           .6 + .25j]],
    "$": [[.8 + 1j, .9j, .6j, .8 + .4j, .8 + .1j, 0], [.4, .4 + 1j]],
    "&": [[.8, .7j, 1j, .7 + 1j, .7 + .7j, .3j, 0, .4, .8 + .27j]],
    " ": [],
}
